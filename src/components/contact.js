        ...
        <div className="contact-about">
          <div className="contact-text2">
            ...
            <p class="about-me-text">
              I'm Roi Malka, a <strong>Front-end developer</strong>. I'm a chill
              guy who likes making things with web technologies. <br />I like to{" "}
              ...
              <strong>web applications</strong>. <br /> I <strong>build</strong>{" "}
              new projects just to tickle my brain and love explaining others
              how they're made. <strong>for hire</strong>.
            </p>
          </div>
